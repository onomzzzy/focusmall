...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r127.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r134); const ctx_r133 = ɵngcc0.ɵɵnextContext(); return ctx_r133.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r128 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r128.rows)("first", ctx_r128.first)("totalRecords", ctx_r128.totalRecords)("pageLinkSize", ctx_r128.pageLinks)("alwaysShow", ctx_r128.alwaysShowPaginator)("rowsPerPageOptions", ctx_r128.rowsPerPageOptions)("dropdownAppendTo", ctx_r128.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r128.paginatorDropdownScrollHeight)("templateLeft", ctx_r128.paginatorLeftTemplate)("templateRight", ctx_r128.paginatorRightTemplate)("currentPageReportTemplate", ctx_r128.currentPageReportTemplate)("showCurrentPageReport", ctx_r128.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowIndex_r136 = ctx.index;
    const ctx_r129 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r129.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r135, rowIndex_r136));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r130.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r139); const ctx_r138 = ɵngcc0.ɵɵnextContext(); return ctx_r138.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r131 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r131.rows)("first", ctx_r131.first)("totalRecords", ctx_r131.totalRecords)("pageLinkSize", ctx_r131.pageLinks)("alwaysShow", ctx_r131.alwaysShowPaginator)("rowsPerPageOptions", ctx_r131.rowsPerPageOptions)("dropdownAppendTo", ctx_r131.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r131.paginatorDropdownScrollHeight)("templateLeft", ctx_r131.paginatorLeftTemplate)("templateRight", ctx_r131.paginatorRightTemplate)("currentPageReportTemplate", ctx_r131.currentPageReportTemplate)("showCurrentPageReport", ctx_r131.showCurrentPageReport);
} }
