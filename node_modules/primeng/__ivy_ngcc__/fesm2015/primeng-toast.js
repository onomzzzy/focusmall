...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r161); const ctx_r160 = ɵngcc0.ɵɵnextContext(); return ctx_r160.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r161); const ctx_r162 = ɵngcc0.ɵɵnextContext(); return ctx_r162.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r158.message.severity == "info", ctx_r158.message.severity == "warn", ctx_r158.message.severity == "error", ctx_r158.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r158.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r158.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r168); const ctx_r167 = ɵngcc0.ɵɵnextContext(); return ctx_r167.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r168); const ctx_r169 = ɵngcc0.ɵɵnextContext(); return ctx_r169.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r165 = ctx.$implicit;
    const i_r166 = ctx.index;
    const ctx_r164 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r165)("index", i_r166)("template", ctx_r164.template)("@toastAnimation", undefined)("showTransitionOptions", ctx_r164.showTransitionOptions)("hideTransitionOptions", ctx_r164.hideTransitionOptions);
} }
